// TODO neewe rotation data. rotate()calls their common rotation offset data  for JSTI
// L AND Z is the same data but reflected
//
//
...
document.addEventListener('DOMContentLoaded', function () {
    ...
    function startGame() {
        ...
        //wanted to initialize these earlier but maybe not possible
        //leftRepeatTimer = new keyRepeatTimer(moveLeft, 500, 250);
        //rightRepeatTimer = new keyRepeatTimer(moveRight, 500, 250);
        //downRepeatTimer = new keyRepeatTimer(moveDown, 500, 250);
