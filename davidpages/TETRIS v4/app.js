...
//    ]
    ...
    // more color
    // https://coolors.co/000000-b5c7ce-7d4563-54c989-80d0d9-6e97ae-1e85ab-7dac35-d6e181
    ...
    async function loadSounds(callback) {
        // load sounds ----------------------------

        moveSound = new soundClip("aud/tap.wav");
        rotateSound = new soundClip("aud/scrape.wav");
        freezeSound = new soundClip("aud/kick.wav");
        clearSound = new soundClip("aud/ding.wav");
        //        tetrisSound = new soundClip("aud/tap.wav");

        freezeSound.volume = 0.0;
